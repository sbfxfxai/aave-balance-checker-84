...
import { createMarketEdgeLiquidityGetter, createNaiveNetworkEstimator, createNaiveSwapEstimator, getMaxLiquidityMarketSwapPathFromTokenSwapPaths, getNaiveBestMarketSwapPathsFromTokenSwapPaths, getTokenSwapPathsForTokenPair, } from "../swapRouting";
...
describe("mockRouting", () => {
    ...
    it("selects SPOT [DAI-USDC] path for USDC->DAI swap when pool has excess of DAI", () => {
        const allPoolsBalanced = Object.fromEntries(marketKeys.map((marketKey) => [
            marketKey,
            {
                longPoolAmount: usdToToken(100000, baseMarketsInfoData[marketKey].longToken),
                shortPoolAmount: usdToToken(100000, baseMarketsInfoData[marketKey].shortToken),
                maxLongPoolAmount: usdToToken(1000000, baseMarketsInfoData[marketKey].longToken),
                maxShortPoolAmount: usdToToken(1000000, baseMarketsInfoData[marketKey].shortToken),
            },
        ]));
        const marketsInfoData = mockMarketsInfoData(tokensData, marketKeys, {
            ...allPoolsBalanced,
            "SPOT-DAI-USDC": {
                longPoolAmount: usdToToken(110000, tokensData.DAI),
                shortPoolAmount: usdToToken(60000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.DAI),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            },
        });
        const tokenSwapPaths = getTokenSwapPathsForTokenPair(swapPaths, "USDC", "DAI");
        const estimator = createNaiveSwapEstimator(marketsInfoData, false);
    ...
    it("routes through BTC [BTC-USDC] -> SOL [BTC-USDC] -> BTC [BTC-DAI] for optimal pricing", () => {
        ...
        const marketsInfoData = mockMarketsInfoData(tokensData, marketKeys, {
            ...
            "BTC-BTC-USDC": {
                longPoolAmount: usdToToken(60000, tokensData.BTC),
                shortPoolAmount: usdToToken(120000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            },
            // 2nd desired swap USDC -> BTC, back to BTC but profitable
            "SOL-BTC-USDC": {
                longPoolAmount: usdToToken(120000, tokensData.BTC),
                shortPoolAmount: usdToToken(60000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            },
            ...
            "BTC-BTC-DAI": {
                longPoolAmount: usdToToken(100000, tokensData.BTC),
                shortPoolAmount: usdToToken(100000, tokensData.DAI),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.DAI),
            },
        });
        ...
        const paths = getNaiveBestMarketSwapPathsFromTokenSwapPaths({
            ...
            tokenOutAddress: "DAI",
            estimator,
            usdIn: expandDecimals(30000n, USD_DECIMALS),
        });
        const topPath = paths?.[0];
        expect(topPath).toBeDefined();
    ...
    it("does not route USDC-BTC through BTC [BTC-USDC] -> SOL [BTC-USDC] -> BTC [BTC-USDC] for imbalanced liquidity, because of duplicate BTC-BTC-USDC", () => {
        ...
        const marketsInfoData = mockMarketsInfoData(tokensData, marketKeys, {
            ...
            "BTC-BTC-USDC": {
                // Huge imbalance
                longPoolAmount: usdToToken(120000, tokensData.BTC),
                shortPoolAmount: usdToToken(20000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            },
            // 2nd desired swap BTC -> USDC, back to BTC but profitable
            "SOL-BTC-USDC": {
                longPoolAmount: usdToToken(70000, tokensData.BTC),
                shortPoolAmount: usdToToken(100000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            },
        });
    ...
    it("selects BTC [BTC-USDC] direct path when impact factors penalize multi-hop routes", () => {
        const allPoolsBalanced = Object.fromEntries(marketKeys.map((marketKey) => [
            marketKey,
            {
                ...
                longPoolAmount: usdToToken(500000, baseMarketsInfoData[marketKey].longToken),
                shortPoolAmount: usdToToken(500000, baseMarketsInfoData[marketKey].shortToken),
                maxLongPoolAmount: usdToToken(1000000, baseMarketsInfoData[marketKey].longToken),
                maxShortPoolAmount: usdToToken(1000000, baseMarketsInfoData[marketKey].shortToken),
            },
        ]));
        const marketsInfoData = mockMarketsInfoData(tokensData, marketKeys, {
            ...
            "BTC-BTC-USDC": {
                // Huge imbalance
                longPoolAmount: usdToToken(150000, tokensData.BTC),
                shortPoolAmount: usdToToken(20000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
            ...
            "SOL-BTC-USDC": {
                longPoolAmount: usdToToken(80000, tokensData.BTC),
                shortPoolAmount: usdToToken(100000, tokensData.USDC),
                maxLongPoolAmount: usdToToken(1000000, tokensData.BTC),
                maxShortPoolAmount: usdToToken(1000000, tokensData.USDC),
                swapImpactFactorPositive: expandDecimals(1, 23),
        ...
        const paths = getNaiveBestMarketSwapPathsFromTokenSwapPaths({
            ...
            tokenOutAddress: "BTC",
            estimator,
            usdIn: expandDecimals(70000n, USD_DECIMALS),
        });
        const topPath = paths?.[0];
        expect(topPath).toBeDefined();
        expect(topPath).toEqual(["BTC-BTC-USDC"]);
...
describe("getMaxLiquidityMarketSwapPathFromTokenSwapPaths", () => {
    ...
    it("selects direct path when multi-hop path has lower minimum liquidity", () => {
        ...
        const marketsInfoData = mockMarketsInfoData(tokensData, marketKeys, {
            ...
            "BTC-BTC-DAI": {
                longPoolAmount: usdToToken(1000000, tokensData.BTC),
                shortPoolAmount: usdToToken(1000000, tokensData.DAI),
            },
        });
        const tokenSwapPaths = getTokenSwapPathsForTokenPair(swapPaths, "BTC", "DAI");
        const result = getMaxLiquidityMarketSwapPathFromTokenSwapPaths({
