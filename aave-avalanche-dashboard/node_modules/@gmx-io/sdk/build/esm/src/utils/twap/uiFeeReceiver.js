...
export function createTwapUiFeeReceiver({ numberOfParts }) {
...
export function decodeTwapUiFeeReceiver(address) {
...
export function isValidTwapUiFeeReceiver(address) {
    return isAddress(address) && address.toLowerCase().startsWith(PREFIX.toLowerCase());
}
export function setUiFeeReceiverIsExpress(uiFeeReceiver, isExpress) {
