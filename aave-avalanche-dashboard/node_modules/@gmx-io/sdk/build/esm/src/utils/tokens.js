...
export function convertBetweenTokens(tokenAmount, fromToken, toToken, maximize) {
...
export function getIsWrap(token1, token2) {
    return token1.isNative && token2.isWrapped;
}
export function getIsUnwrap(token1, token2) {
    return token1.isWrapped && token2.isNative;
}
export function getIsStake(token1, token2) {
    return (token1.isWrapped || token1.isNative) && token2.isStaking;
}
export function getIsUnstake(token1, token2) {
