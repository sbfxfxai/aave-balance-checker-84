...
import { applyFactor, basisPointsToFloat, bigintToNumber, BN_NEGATIVE_ONE, BN_ONE, BN_ZERO, expandDecimals, formatAmount, formatAmountHuman, formatBalanceAmount, formatFactor, formatPercentage, formatUsdPrice, getBasisPoints, numberToBigint, PERCENT_PRECISION_DECIMALS, PRECISION, PRECISION_DECIMALS, roundWithDecimals, roundUpMagnitudeDivision, toBigNumberWithDecimals, } from "../numbers";
...
describe("formatUsdPrice", () => {
    ...
    it("should calculate correct decimals if displayDecimals not passed", () => {
        ...
        expect(formatUsdPrice(ONE_USD / 10000n)).toBe("$\u200a0.0001000");
        expect(formatUsdPrice(ONE_USD / 100000n)).toBe("$\u200a0.00001000");
        expect(formatUsdPrice(ONE_USD / 1000000000n)).toBe("$\u200a0.000000001");
        expect(formatUsdPrice(ONE_USD / 10000000000n)).toBe("<\u00a0$\u200a0.000000001");
    });
});
...
describe("formatBalanceAmount", () => {
    it("should display balance amount", () => {
        ...
        expect(formatBalanceAmount(ONE_USD / 1000n, USD_DECIMALS)).toBe("0.0010000");
        expect(formatBalanceAmount(ONE_USD / 10000n, USD_DECIMALS)).toBe("0.00010000");
        expect(formatBalanceAmount(ONE_USD / 100000n, USD_DECIMALS)).toBe("0.00001000");
        expect(formatBalanceAmount(ONE_USD / 1000000n, USD_DECIMALS)).toBe("0.00000100");
        expect(formatBalanceAmount(ONE_USD / 10000000n, USD_DECIMALS)).toBe("0.00000010");
        expect(formatBalanceAmount(ONE_USD / 100000000n, USD_DECIMALS)).toBe("0.00000001");
        expect(formatBalanceAmount(ONE_USD / 1000000000n, USD_DECIMALS)).toBe("1.00e-9");
        expect(formatBalanceAmount(ONE_USD / 1000000000000n, USD_DECIMALS)).toBe("1.00e-12");
        expect(formatBalanceAmount(ONE_USD * -1n, USD_DECIMALS)).toBe("-1.0000");
    });
    ...
    it("should display balance of stable token correctly", () => {
        ...
        expect(formatBalanceAmount(ONE_USD / 1000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00100");
        expect(formatBalanceAmount(ONE_USD / 10000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00010000");
        expect(formatBalanceAmount(ONE_USD / 100000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00001000");
        expect(formatBalanceAmount(ONE_USD / 1000000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00000100");
        expect(formatBalanceAmount(ONE_USD / 10000000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00000010");
        expect(formatBalanceAmount(ONE_USD / 100000000n, USD_DECIMALS, undefined, { isStable: true })).toBe("0.00000001");
        expect(formatBalanceAmount(ONE_USD / 1000000000n, USD_DECIMALS, undefined, { isStable: true })).toBe("1.00e-9");
...
describe("formatPercentage", () => {
    ...
    it("should handle basis points (bps) formatting", () => {
        expect(formatPercentage(toBigNumberWithDecimals("1", PERCENT_PRECISION_DECIMALS), { bps: false, displayDecimals: 4 })).toBe("1.0000%");
        expect(formatPercentage(toBigNumberWithDecimals("0.999", PERCENT_PRECISION_DECIMALS), { bps: false, displayDecimals: 5 })).toBe("0.99900%");
    });
});
