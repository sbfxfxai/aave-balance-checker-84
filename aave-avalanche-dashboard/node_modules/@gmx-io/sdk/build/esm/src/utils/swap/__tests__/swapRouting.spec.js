...
import { createMarketEdgeLiquidityGetter, createNaiveSwapEstimator, createSwapEstimator, getBestMarketForTokenEdge, getBestSwapPath, getMaxLiquidityMarketForTokenEdge, getMaxLiquidityMarketSwapPathFromTokenSwapPaths, getNaiveBestMarketSwapPathsFromTokenSwapPaths, } from "../swapRouting";
...
describe("getBestMarketForTokenEdge", () => {
    ...
    it("should pass correct parameters to estimator", () => {
        ...
        expect(calledWithUsdIn).toBe(1000000n * dollar);
    });
});
