...
import { MaxUint256, parseValue, USD_DECIMALS } from "../../numbers";
import { buildDecreaseOrderPayload, buildTwapOrdersPayloads, getIsTwapOrderPayload, } from "../../orderTransactions";
import { decodeTwapUiFeeReceiver } from "../../twap/uiFeeReceiver";
...
describe("Decrease Order Payloads", () => {
    ...
    describe("buildDecreaseOrderPayload", () => {
        ...
        it("TWAP Decrease Long", () => {
            ...
            expect(expectedOrders.every((co) => getIsTwapOrderPayload(co.orderPayload))).toBe(true);
        });
