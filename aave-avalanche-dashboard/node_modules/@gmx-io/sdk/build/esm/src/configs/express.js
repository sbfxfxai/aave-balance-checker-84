...
export const SUBACCOUNT_MESSAGE = "Generate a GMX 1CT (One-Click Trading) session. Only sign this message on a trusted website.";
...
export function getGasPaymentTokens(chainId) {
    return GAS_PAYMENT_TOKENS[chainId];
}
export function getDefaultGasPaymentToken(chainId) {
    return GAS_PAYMENT_TOKENS[chainId][0];
}
export function getRelayerFeeToken(chainId) {
