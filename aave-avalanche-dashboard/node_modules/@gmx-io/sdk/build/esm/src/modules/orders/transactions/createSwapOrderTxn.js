...
export async function createSwapOrderTxn(sdk, p) {
    ...
    await sdk.callContract(getContract(sdk.chainId, "ExchangeRouter"), abis.ExchangeRouter, "multicall", [encodedPayload], {
...
async function getParams(sdk, p) {
    ...
    return {
        ...
        encodedPayload: multicall
            .filter(Boolean)
            .map((call) => encodeFunctionData({ abi: abis.ExchangeRouter, functionName: call.method, args: call.params })),
    };
}
