...
export async function increaseOrderHelper(sdk, params) {
...
export async function swap(sdk, params) {
    const { tokensData, marketsInfoData, uiFeeFactor, gasLimits, gasPrice } = await getAndValidateBaseParams(sdk, params);
    ...
    const isWrapOrUnwrap = Boolean(fromToken && toToken && (getIsWrap(fromToken, toToken) || getIsUnwrap(fromToken, toToken)));
    if (isWrapOrUnwrap) {
        const fromTokenPrice = fromToken.prices.minPrice;
