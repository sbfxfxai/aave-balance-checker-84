...
export function buildClaimableFundingDataRequest({ marketsAddresses, marketsData, chainId, account, }) {
    if (!marketsAddresses) {
        return {};
    }
...
export async function buildMarketsValuesRequest(chainId, { marketsAddresses, marketsData, tokensData, dataStoreAddress, syntheticsReaderAddress, }) {
    const request = {};
...
export async function buildMarketsConfigsRequest(chainId, { marketsData, marketsAddresses, dataStoreAddress, }) {
    const request = {};
    for (const marketAddress of marketsAddresses || []) {
