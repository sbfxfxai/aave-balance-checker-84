...
describe("increaseOrderHelper", () => {
    ...
    describe("parameters", () => {
        ...
        it("should call createIncreaseOrder with correct parameters for a market order with payAmount", async () => {
            ...
            expect(findSwapPathSpy).toHaveBeenCalledWith(expect.objectContaining({
                chainId: ARBITRUM,
                fromTokenAddress: payToken.address,
                toTokenAddress: collateralToken.address,
                marketsInfoData: expect.any(Object),
            }));
            expect(getIncreasePositionAmountsSpy).toHaveBeenCalledWith(expect.objectContaining({
                isLong: true,
            ...
            expect(createIncreaseOrderSpy).toHaveBeenCalledWith(expect.objectContaining({
                marketsInfoData: expect.any(Object),
