...
import { EXECUTION_FEE_CONFIG_V2, GAS_LIMITS_STATIC_CONFIG, GAS_PRICE_PREMIUM_MAP, getViemChain, MAX_PRIORITY_FEE_PER_GAS_MAP, } from "../../configs/chains";
import { getContract } from "../../configs/contracts";
import { decreaseOrderGasLimitKey, depositGasLimitKey, ESTIMATED_GAS_FEE_BASE_AMOUNT_V2_1, ESTIMATED_GAS_FEE_MULTIPLIER_FACTOR, ESTIMATED_GAS_FEE_PER_ORACLE_PRICE, GELATO_RELAY_FEE_MULTIPLIER_FACTOR_KEY, GLV_DEPOSIT_GAS_LIMIT, GLV_PER_MARKET_GAS_LIMIT, GLV_WITHDRAWAL_GAS_LIMIT, increaseOrderGasLimitKey, shiftGasLimitKey, singleSwapGasLimitKey, swapOrderGasLimitKey, uiFeeFactorKey, withdrawalGasLimitKey, } from "../../configs/dataStore";
import { bigMath } from "../../utils/bigmath";
import { estimateOrderOraclePriceCount } from "../../utils/fees/estimateOraclePriceCount";
import { estimateExecuteDecreaseOrderGasLimit, estimateExecuteIncreaseOrderGasLimit, estimateExecuteSwapOrderGasLimit, getExecutionFee, } from "../../utils/fees/executionFee";
...
export class Utils extends Module {
    ...
    async getGasPrice() {
        ...
        const feeData = await withRetry(() => this.sdk.publicClient.estimateFeesPerGas({
        ...
        if (executionFeeConfig.shouldUseMaxPriorityFeePerGas) {
            const maxPriorityFeePerGas = bigMath.max(feeData?.maxPriorityFeePerGas ?? 0n, MAX_PRIORITY_FEE_PER_GAS_MAP[this.chainId] ?? 0n);
