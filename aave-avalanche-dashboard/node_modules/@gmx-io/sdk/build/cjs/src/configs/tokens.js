...
exports.isUsdBasedStableToken = exports.createTokensMap = exports.getCategoryTokenAddresses = exports.getStableTokens = exports.getTokenVisualMultiplier = exports.isSimilarToken = exports.isTokenInList = exports.getTokenBySymbolSafe = exports.getPriceDecimals = exports.isChartAvailableForToken = exports.getNormalizedTokenSymbol = exports.convertTokenAddress = exports.getTokenBySymbol = exports.getToken = exports.isValidTokenSafe = exports.isValidToken = exports.getVisibleV1Tokens = exports.getWhitelistedV1Tokens = exports.getTokensMap = exports.getV2Tokens = exports.getV1Tokens = exports.getTokens = exports.getNativeToken = exports.getWrappedToken = exports.getSyntheticTokens = exports.NATIVE_TOKENS_MAP = exports.WRAPPED_TOKENS_MAP = exports.TOKENS_BY_SYMBOL_MAP = exports.SYNTHETIC_TOKENS = exports.V2_TOKENS = exports.V1_TOKENS = exports.TOKENS_MAP = exports.TOKEN_COLOR_MAP = exports.TOKENS = exports.NATIVE_TOKEN_ADDRESS = void 0;
const viem_1 = require("viem");
const chains_1 = require("./chains");
const contracts_1 = require("./contracts");
exports.NATIVE_TOKEN_ADDRESS = viem_1.zeroAddress;
exports.TOKENS = {
    [chains_1.ARBITRUM]: [
        {
            name: "Ethereum",
        ...
        },
        {
            name: "GMX",
            symbol: "GMX",
            address: (0, contracts_1.getContract)(chains_1.ARBITRUM, "GMX"),
            decimals: 18,
        ...
        },
        {
            name: "Escrowed GMX",
            symbol: "ESGMX",
            address: (0, contracts_1.getContract)(chains_1.ARBITRUM, "ES_GMX"),
            decimals: 18,
            isPlatformToken: true,
        },
        {
        ...
        },
        {
            name: "GMX LP",
            symbol: "GLP",
            address: (0, contracts_1.getContract)(chains_1.ARBITRUM, "GLP"),
            decimals: 18,
    ...
    [chains_1.AVALANCHE]: [
        ...
        },
        {
            name: "GMX",
            symbol: "GMX",
            address: (0, contracts_1.getContract)(chains_1.AVALANCHE, "GMX"),
            decimals: 18,
            imageUrl: "https://assets.coingecko.com/coins/images/18323/small/arbit.png?1631532468",
            isPlatformToken: true,
            categories: ["defi"],
        ...
        },
        {
            name: "Escrowed GMX",
            symbol: "ESGMX",
            address: (0, contracts_1.getContract)(chains_1.AVALANCHE, "ES_GMX"),
            decimals: 18,
            isPlatformToken: true,
        },
        {
            name: "GMX LP",
            symbol: "GLP",
            address: (0, contracts_1.getContract)(chains_1.AVALANCHE, "GLP"),
            decimals: 18,
            isPlatformToken: true,
            imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
...
exports.V1_TOKENS = {};
exports.V2_TOKENS = {};
exports.SYNTHETIC_TOKENS = {};
exports.TOKENS_BY_SYMBOL_MAP = {};
exports.WRAPPED_TOKENS_MAP = {};
exports.NATIVE_TOKENS_MAP = {};
const CHAIN_IDS = [chains_1.ARBITRUM, chains_1.AVALANCHE, chains_1.AVALANCHE_FUJI, chains_1.BOTANIX, chains_1.ARBITRUM_SEPOLIA];
for (let j = 0; j < CHAIN_IDS.length; j++) {
    const chainId = CHAIN_IDS[j];
    exports.TOKENS_MAP[chainId] = {};
    exports.TOKENS_BY_SYMBOL_MAP[chainId] = {};
    exports.SYNTHETIC_TOKENS[chainId] = [];
    exports.V1_TOKENS[chainId] = [];
    exports.V2_TOKENS[chainId] = [];
    let tokens = exports.TOKENS[chainId];
    let wrappedTokenAddress;
    for (let i = 0; i < tokens.length; i++) {
        const token = tokens[i];
        exports.TOKENS_MAP[chainId][token.address] = token;
        exports.TOKENS_BY_SYMBOL_MAP[chainId][token.symbol] = token;
        if (token.isWrapped) {
            exports.WRAPPED_TOKENS_MAP[chainId] = token;
            wrappedTokenAddress = token.address;
        }
        if (token.isNative) {
            exports.NATIVE_TOKENS_MAP[chainId] = token;
        }
        if (token.isV1Available && !token.isTempHidden) {
            exports.V1_TOKENS[chainId].push(token);
        }
        if ((!token.isPlatformToken || (token.isPlatformToken && token.isPlatformTradingToken)) && !token.isTempHidden) {
            exports.V2_TOKENS[chainId].push(token);
        }
        if (token.isSynthetic) {
            exports.SYNTHETIC_TOKENS[chainId].push(token);
        }
    }
    exports.NATIVE_TOKENS_MAP[chainId].wrappedAddress = wrappedTokenAddress;
}
function getSyntheticTokens(chainId) {
    return exports.SYNTHETIC_TOKENS[chainId];
}
exports.getSyntheticTokens = getSyntheticTokens;
function getWrappedToken(chainId) {
    return exports.WRAPPED_TOKENS_MAP[chainId];
}
exports.getWrappedToken = getWrappedToken;
function getNativeToken(chainId) {
    return exports.NATIVE_TOKENS_MAP[chainId];
}
exports.getNativeToken = getNativeToken;
function getTokens(chainId) {
    return exports.TOKENS[chainId];
}
exports.getTokens = getTokens;
function getV1Tokens(chainId) {
    return exports.V1_TOKENS[chainId];
}
exports.getV1Tokens = getV1Tokens;
function getV2Tokens(chainId) {
    return exports.V2_TOKENS[chainId];
}
exports.getV2Tokens = getV2Tokens;
function getTokensMap(chainId) {
    return exports.TOKENS_MAP[chainId];
}
exports.getTokensMap = getTokensMap;
function getWhitelistedV1Tokens(chainId) {
    return getV1Tokens(chainId);
}
exports.getWhitelistedV1Tokens = getWhitelistedV1Tokens;
function getVisibleV1Tokens(chainId) {
    return getV1Tokens(chainId).filter((token) => !token.isWrapped);
}
exports.getVisibleV1Tokens = getVisibleV1Tokens;
function isValidToken(chainId, address) {
    if (!exports.TOKENS_MAP[chainId]) {
        throw new Error(`Incorrect chainId ${chainId}`);
    }
    return address in exports.TOKENS_MAP[chainId];
}
exports.isValidToken = isValidToken;
function isValidTokenSafe(chainId, address) {
    return address in exports.TOKENS_MAP[chainId];
}
exports.isValidTokenSafe = isValidTokenSafe;
function getToken(chainId, address) {
    // FIXME APE_deprecated token which is not in use but can be displayed
    if (chainId === chains_1.ARBITRUM && address === "0x74885b4D524d497261259B38900f54e6dbAd2210") {
        return getTokenBySymbol(chainId, "APE");
    }
    if (!exports.TOKENS_MAP[chainId]) {
        throw new Error(`Incorrect chainId ${chainId}`);
    }
    if (!exports.TOKENS_MAP[chainId][address]) {
        throw new Error(`Incorrect address "${address}" for chainId ${chainId}`);
    }
    return exports.TOKENS_MAP[chainId][address];
}
exports.getToken = getToken;
function getTokenBySymbol(chainId, symbol, { isSynthetic, version, symbolType = "symbol", } = {}) {
    let tokens = Object.values(exports.TOKENS_MAP[chainId]);
    if (version) {
    ...
    if (isSynthetic !== undefined) {
        ...
        if (symbolType === "symbol" && exports.TOKENS_BY_SYMBOL_MAP[chainId][symbol]) {
            token = exports.TOKENS_BY_SYMBOL_MAP[chainId][symbol];
        }
        else {
...
function convertTokenAddress(chainId, address, convertTo) {
    ...
    if (convertTo === "wrapped" && address === exports.NATIVE_TOKEN_ADDRESS) {
        return wrappedToken.address;
    }
    if (convertTo === "native" && address === wrappedToken.address) {
        return exports.NATIVE_TOKEN_ADDRESS;
    }
    return address;
}
exports.convertTokenAddress = convertTokenAddress;
...
exports.getNormalizedTokenSymbol = getNormalizedTokenSymbol;
function isChartAvailableForToken(chainId, tokenSymbol) {
    ...
    if (token.isChartDisabled || (token.isPlatformToken && !token.isPlatformTradingToken))
        return false;
    return true;
}
exports.isChartAvailableForToken = isChartAvailableForToken;
function getPriceDecimals(chainId, tokenSymbol) {
    if (!tokenSymbol)
        return 2;
    try {
...
function getTokenBySymbolSafe(chainId, symbol, params = {}) {
    try {
...
exports.getTokenBySymbolSafe = getTokenBySymbolSafe;
function isTokenInList(token, tokenList) {
    return tokenList.some((t) => t.address === token.address);
}
exports.isTokenInList = isTokenInList;
function isSimilarToken(tokenA, tokenB) {
...
exports.isSimilarToken = isSimilarToken;
function getTokenVisualMultiplier(token) {
    return token.visualPrefix || token.visualMultiplier?.toString() || "";
}
exports.getTokenVisualMultiplier = getTokenVisualMultiplier;
function getStableTokens(chainId) {
    return getTokens(chainId).filter((t) => t.isStable);
}
exports.getStableTokens = getStableTokens;
function getCategoryTokenAddresses(chainId, category) {
    return exports.TOKENS[chainId].filter((token) => token.categories?.includes(category)).map((token) => token.address);
}
exports.getCategoryTokenAddresses = getCategoryTokenAddresses;
...
exports.createTokensMap = createTokensMap;
...
exports.isUsdBasedStableToken = isUsdBasedStableToken;
