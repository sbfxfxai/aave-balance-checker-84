...
exports.fixTokenSymbolFromMarketLabel = exports.getMarketByLabel = exports.MARKETS = exports.SWAP_GRAPH_MAX_MARKETS_PER_TOKEN = void 0;
/*
...
exports.SWAP_GRAPH_MAX_MARKETS_PER_TOKEN = 5;
/*
  ATTENTION
...
function getMarketByLabel(chainId, label) {
    const marketsByAddress = exports.MARKETS[chainId];
    if (!marketsByAddress) {
    ...
    const indexToken = (0, tokens_1.getTokenBySymbol)(chainId, (0, exports.fixTokenSymbolFromMarketLabel)(chainId, indexSymbolRaw));
    const longToken = (0, tokens_1.getTokenBySymbol)(chainId, (0, exports.fixTokenSymbolFromMarketLabel)(chainId, longSymbolRaw), {
        isSynthetic: false,
    });
    const shortToken = (0, tokens_1.getTokenBySymbol)(chainId, (0, exports.fixTokenSymbolFromMarketLabel)(chainId, shortSymbolRaw), {
        isSynthetic: false,
    });
    if (!longToken || !shortToken || !indexToken) {
        throw new Error(`Invalid market label ${label}`);
    }
    const market = Object.values(marketsByAddress).find((market) => market.longTokenAddress === longToken.address &&
...
exports.getMarketByLabel = getMarketByLabel;
const fixTokenSymbolFromMarketLabel = (chainId, symbol) => {
    if (chainId === chains_1.ARBITRUM && symbol === "WBTC") {
        return "BTC";
    }
    if (chainId === chains_1.ARBITRUM && symbol === "ETH") {
        return "WETH";
    }
    return symbol;
};
exports.fixTokenSymbolFromMarketLabel = fixTokenSymbolFromMarketLabel;
