...
exports.getContract = exports.CONTRACTS = void 0;
...
exports.CONTRACTS = {
    ...
    [chains_1.AVALANCHE]: {
        ...
        ArbitrumNodeInterface: viem_1.zeroAddress,
        LayerZeroEndpoint: "0x1a44076050125825900e736c501f859c50fE728c",
        GelatoRelayAddress: "0xaBcC9b596420A9E9172FD5938620E265a0f9Df92",
    },
    [chains_1.BOTANIX]: {
        ...
        OpenOceanRouter: viem_1.zeroAddress,
        ...
        Vault: viem_1.zeroAddress,
        Reader: viem_1.zeroAddress,
        PositionRouter: viem_1.zeroAddress,
        ReferralStorage: viem_1.zeroAddress,
        VaultReader: viem_1.zeroAddress,
        GlpManager: viem_1.zeroAddress,
        RewardRouter: viem_1.zeroAddress,
        RewardReader: viem_1.zeroAddress,
        GlpRewardRouter: viem_1.zeroAddress,
        StakedGmxTracker: viem_1.zeroAddress,
        FeeGmxTracker: viem_1.zeroAddress,
        GLP: viem_1.zeroAddress,
        GMX: viem_1.zeroAddress,
        ES_GMX: viem_1.zeroAddress,
        BN_GMX: viem_1.zeroAddress,
        USDG: viem_1.zeroAddress,
        BonusGmxTracker: viem_1.zeroAddress,
        StakedGlpTracker: viem_1.zeroAddress,
        FeeGlpTracker: viem_1.zeroAddress,
        ExtendedGmxTracker: viem_1.zeroAddress,
        StakedGmxDistributor: viem_1.zeroAddress,
        StakedGlpDistributor: viem_1.zeroAddress,
        GmxVester: viem_1.zeroAddress,
        GlpVester: viem_1.zeroAddress,
        AffiliateVester: viem_1.zeroAddress,
        Router: viem_1.zeroAddress,
        GovToken: viem_1.zeroAddress,
        ES_GMX_IOU: viem_1.zeroAddress,
        OrderBook: viem_1.zeroAddress,
        UniswapGmxEthPool: viem_1.zeroAddress,
        // botanix specific
    ...
    [chains_1.AVALANCHE_FUJI]: {
        ...
        AffiliateVester: viem_1.zeroAddress,
        PositionRouter: viem_1.zeroAddress,
        TraderJoeGmxAvaxPool: viem_1.zeroAddress,
    ...
    [chains_1.ARBITRUM_SEPOLIA]: {
        ...
        ArbitrumNodeInterface: "0x00000000000000000000000000000000000000C8",
        GelatoRelayAddress: "0xaBcC9b596420A9E9172FD5938620E265a0f9Df92",
        ExternalHandler: viem_1.zeroAddress,
        GLP: viem_1.zeroAddress,
        GMX: viem_1.zeroAddress,
        ES_GMX: viem_1.zeroAddress,
        BN_GMX: viem_1.zeroAddress,
...
function getContract(chainId, name) {
    if (!exports.CONTRACTS[chainId]) {
        throw new Error(`Unknown chainId ${chainId}`);
    }
    if (!exports.CONTRACTS[chainId][name]) {
        throw new Error(`Unknown contract "${name}" for chainId ${chainId}`);
    }
    return exports.CONTRACTS[chainId][name];
}
