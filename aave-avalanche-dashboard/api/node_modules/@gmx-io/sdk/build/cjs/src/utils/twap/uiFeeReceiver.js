...
exports.setUiFeeReceiverIsExpress = exports.isValidTwapUiFeeReceiver = exports.decodeTwapUiFeeReceiver = exports.createTwapUiFeeReceiver = exports.generateTwapId = void 0;
...
exports.generateTwapId = generateTwapId;
...
exports.createTwapUiFeeReceiver = createTwapUiFeeReceiver;
...
exports.decodeTwapUiFeeReceiver = decodeTwapUiFeeReceiver;
function isValidTwapUiFeeReceiver(address) {
    return (0, viem_1.isAddress)(address) && address.toLowerCase().startsWith(PREFIX.toLowerCase());
}
exports.isValidTwapUiFeeReceiver = isValidTwapUiFeeReceiver;
...
exports.setUiFeeReceiverIsExpress = setUiFeeReceiverIsExpress;
