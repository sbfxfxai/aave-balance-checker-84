...
exports.hasVenusDeployment = exports.getVenusDeployment = exports.VENUS_EXCHANGE_RATE_DECIMALS = void 0;
const chains_1 = require("./chains");
exports.VENUS_EXCHANGE_RATE_DECIMALS = 18n;
const VENUS_DEPLOYMENTS = {
    [chains_1.ARBITRUM]: {
...
function getVenusDeployment(chainId) {
    return VENUS_DEPLOYMENTS[chainId];
}
exports.getVenusDeployment = getVenusDeployment;
function hasVenusDeployment(chainId) {
    return Boolean(getVenusDeployment(chainId));
}
exports.hasVenusDeployment = hasVenusDeployment;
