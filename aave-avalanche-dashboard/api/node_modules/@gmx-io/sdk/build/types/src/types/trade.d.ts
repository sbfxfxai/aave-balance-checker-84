...
export type SwapEstimator = (e: MarketEdge, usdIn: bigint) => {
    usdOut: bigint;
};
export type NaiveSwapEstimator = (e: MarketEdge, usdIn: bigint) => {
    /**
...
export type NaiveNetworkEstimator = (usdIn: bigint, swapCount: number) => {
    networkYield: number;
    usdOut: bigint;
};
export type MarketEdgeLiquidityGetter = (e: MarketEdge) => bigint;
export type SwapOptimizationOrderArray = ("liquidity" | "length")[];
export type FindSwapPath = (usdIn: bigint, opts?: {
    order?: SwapOptimizationOrderArray;
