...
export function usdToToken(usd, token) {
...
export function mockTokensData(overrides = {}) {
    const tokens = {
        ...overrides,
        AVAX: {
            address: "AVAX",
 ...
 */
export function mockMarketsData(marketKeys) {
...
export function mockMarketsInfoData(tokensData, marketKeys, overrides = {}) {
    return marketKeys.reduce((acc, key) => {
        const [indexTokenAddress, longTokenAddress, shortTokenAddress] = key.split("-");
...
export function mockExternalSwap({ inToken, outToken, amountIn, amountOut, priceIn, priceOut, feesUsd = expandDecimals(5, USD_DECIMALS), // $5 default fee
