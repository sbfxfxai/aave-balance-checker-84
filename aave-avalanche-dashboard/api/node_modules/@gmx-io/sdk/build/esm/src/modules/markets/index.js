...
import { buildClaimableFundingDataRequest, buildMarketsConfigsRequest, buildMarketsValuesRequest, } from "./query-builders";
export class Markets extends Module {
    async getClaimableFundingData() {
        ...
        return this.sdk
            .executeMulticall(buildClaimableFundingDataRequest({
            chainId,
            account,
            marketsAddresses,
            marketsData,
    ...
    async getDailyVolumes() {
        ...
        return graphqlFetcher(endpoint, POSITIONS_VOLUME_INFOS_QUERY).then((data) => {
