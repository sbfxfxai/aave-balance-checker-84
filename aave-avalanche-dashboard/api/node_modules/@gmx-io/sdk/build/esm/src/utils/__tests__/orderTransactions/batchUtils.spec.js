...
import { expandDecimals, parseValue, USD_DECIMALS } from "../../numbers";
import { buildIncreaseOrderPayload, getBatchExternalCalls, getBatchExternalSwapGasLimit, getBatchIsNativePayment, getBatchTotalExecutionFee, getBatchTotalPayCollateralAmount, getIsEmptyBatch, getIsInvalidBatchReceiver, } from "../../orderTransactions";
...
describe("Batch Utils", () => {
    ...
    describe("getBatchTotalExecutionFee", () => {
        it("calculates total execution fee including top-ups", () => {
            ...
            batch.updateOrderParams = [{ updatePayload: { executionFeeTopUp: parseValue("0.05", WETH.decimals) } }];
            const tokensData = {
                [WETH.address]: {
                    ...WETH,
                    prices: {
