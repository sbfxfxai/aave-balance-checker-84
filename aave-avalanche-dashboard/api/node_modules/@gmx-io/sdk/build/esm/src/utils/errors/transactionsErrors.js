...
export function getIsUserRejectedError(errorType) {
    return errorType === TxErrorType.UserDenied;
}
export function getIsUserError(errorType) {
 ...
 */
export function extractTxnError(ex) {
    if (!ex) {
        return [];
    }
