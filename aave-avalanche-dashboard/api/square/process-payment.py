"""
Square payment processing endpoint for Vercel
Handles POST /api/square/process-payment
"""
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        """GET not allowed for payment processing"""
        create_json_response(self, 405, {
            "success": False,
            "error": {
                "message": "Use POST for payment processing",
